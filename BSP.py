            ...
            for partition in partitions:
                if partition.splitable:
                    ...
                    if split == 0:
                        ...
                        if temp_w <= 250 and (temp_w < partition.height*1.5 or temp_w*1.5 > partition.height):
                        ...
                        if temp_h <= 250 and (temp_h < partition.width*1.5 or temp_h*1.5 > partition.width):
